...
ggsave("~/GitHubRepos/CareyLabVT/Powell/Plots/LitReview/NPSReport/sitemap.jpg", plot = sitemap, height = 7, width = 8, units = "in")
```
...
mgmtconcerns
ggsave("~/GitHubRepos/CareyLabVT/Powell/Plots/LitReview/NPSReport/managementconcerns.png", plot = mgmtconcerns, height = 6, width = 10, units = "in")
